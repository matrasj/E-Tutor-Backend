...
public interface AdvertisementRepository extends JpaRepository<Advertisement, Long> {
    ...
    Page<Advertisement> findByShortDescOrCategoryAndAdvertisementTypeContaining(@Param("keyphrase") String keyphrase,
    ...
    @Query(value = "SELECT DISTINCT advertisement.id, advertisement.advertisement_type, advertisement.content, advertisement.minutes_duration,\n" +
            ...
            ")" +
            "ORDER BY advertisement.created_at DESC", nativeQuery = true)
    Page<Advertisement> findByShortDescOrCategoryContaining(@Param("keyphrase") String keyphrase, Pageable pageable);
